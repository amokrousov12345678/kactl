...
\section{Optimization tricks}
	...
	\subsection{Pragmas}
		\begin{itemize}
			...
			\item \lstinline{#pragma GCC target("sse,sse2,sse3,ssse3,sse4,popcnt,avx,avx2,fma")} --- full list of pragmas.
			\item \lstinline{#pragma GCC optimize ("trapv")} kills the program on integer overflows (but is really slow).
			\item \lstinline{#pragma GCC target("avx2,bmi,bmi2,lzcnt,popcnt")} for heavy bit operations like popcount, ctz.
		\end{itemize}
